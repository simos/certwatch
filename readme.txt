...
you should do the following:
  ...
  2. Put the full path to the folder (e.g. c:\dev\certwatch on
     Windows, /home/user/dev/certwatch on Linux) in a file named
     certwatch@simos.info and copy that file to
